...
export class OrganizationReservationComponentsPage {
  createButton = element(by.css('ion-fab-button'));
  viewButtons = element.all(by.css('ion-item'));
  title = element.all(by.css('ion-title')).get(2);
  noResult = element(by.cssContainingText('ion-label', 'No Organization Reservations found.'));
  entities = element.all(by.css('page-organization-reservation ion-item'));
...
export class OrganizationReservationUpdatePage {
...
export class OrganizationReservationDetailPage {
  pageTitle = element.all(by.css('ion-title')).get(3);
