...
export class ServiceMapComponentsPage {
  createButton = element(by.css('ion-fab-button'));
  viewButtons = element.all(by.css('ion-item'));
  title = element.all(by.css('ion-title')).get(2);
  noResult = element(by.cssContainingText('ion-label', 'No Service Maps found.'));
  entities = element.all(by.css('page-service-map ion-item'));
...
export class ServiceMapUpdatePage {
...
export class ServiceMapDetailPage {
  pageTitle = element.all(by.css('ion-title')).get(3);
