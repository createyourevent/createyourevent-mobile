...
describe('ImageUpdatePage', () => {
  let component: ImageUpdatePage;
  let fixture: ComponentFixture<ImageUpdatePage>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ImageUpdatePage);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });

  it('OnInit', () => {
    expect(component.image).toEqual(entityMock);
  });
});
